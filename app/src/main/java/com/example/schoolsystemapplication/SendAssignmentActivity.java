...
public class SendAssignmentActivity extends AppCompatActivity {
    ...
    private void loadClasses() {
        String url = "http://10.0.2.2/phpFiles/get_classes.php";
    ...
    private void loadSubjects() {
        String url = "http://10.0.2.2/phpFiles//get_subjects.php";
        StringRequest request = new StringRequest(Request.Method.GET, url,
                response -> {
                    try {
                        JSONObject json = new JSONObject(response);
    ...
    private void submitAssignment() {
        ...
        String url = "http://10.0.2.2/phpFiles//add_assignment.php";
