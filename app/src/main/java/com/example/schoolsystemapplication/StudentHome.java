...
public class StudentHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getStudentName(idNumber, welcomeText);
    ...
    private void getStudentName(String idNumber, TextView welcomeText) {
        String url = "http://10.0.2.2:80/php_project/student_name.php";
