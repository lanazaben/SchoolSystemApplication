...
public class RegistrarsHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getRegistrarName(idNumber, welcomeText);
    ...
    private void getRegistrarName(String idNumber, TextView welcomeText) {
        String url = "http://10.0.2.2:80/php_project/registrar_name.php";
                ...
                response -> {
                    try {
                        ...
                        if (obj.getBoolean("success")) {
                            ...
                            welcomeText.setText("Welcome, registrar");
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        welcomeText.setText("Welcome, registrar");
